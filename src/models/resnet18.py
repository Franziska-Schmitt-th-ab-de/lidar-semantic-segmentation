...
# Encoder zur Merkmalsextraktion
class ResNet18Encoder(nn.Module):
    def __init__(self, in_channels=4):
        super(ResNet18Encoder, self).__init__()
        # Laden des vortrainierten ResNet18-Modells
        ...
        # Encoder-Schichten
        self.layer1 = resnet18.layer1  # Ausgabe: 64 Kanäle
        self.layer2 = resnet18.layer2  # Ausgabe: 128 Kanäle
        self.layer3 = resnet18.layer3  # Ausgabe: 256 Kanäle
        self.layer4 = resnet18.layer4  # Ausgabe: 512 Kanäle

        # Initialisierung der angepassten ersten Convolution-Schicht
        nn.init.kaiming_normal_(self.conv1.weight, mode="fan_out", nonlinearity="relu")

    # führt das Bild durch die versch. Schichten
    def forward(self, x):
...
# Decoder für Rekonstruktion zu hochauflösender Ausgabe
# enthält Upsampling und Skip-Connections
class SegmentationDecoder(nn.Module):
    def __init__(self, num_classes):
        ...
        self.iconv1 = nn.Sequential(
            ...
            nn.GroupNorm(
                num_groups=32, num_channels=256
            ),  # besser bei kleinerer batch_size; vorher: nn.BatchNorm2d(256),
            nn.ReLU(inplace=True),
            nn.Dropout(0.3),  # vorher: 0.5
        )
...
# Verbindung vom Encoder und dem Decoder (Gesamtmodell)
...
def get_resnet18(num_classes, **kwargs):
    return ResNet18Segmentation(num_classes=num_classes, **kwargs)
